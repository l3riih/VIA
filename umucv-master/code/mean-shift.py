...
# La nueva posición del objeto será el valor medio
...
for key,frame in autoStream():
    ...
    if H is not None:
        ...
        #    valores en el histograma, indexacion
        ...
        if sL == 0:
            H = None
            continue
            # al calcular la media pondera a partir del historiograma los pixeles que tengan mas probabilidad de pertenecer
            # a la region inicial tendran mas peso
