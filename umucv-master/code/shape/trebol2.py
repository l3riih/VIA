...
# Si la función devuelve , significa que el contorno está orientado en el sentido de las agujas del reloj,
# y si devuelve , significa que el contorno está orientado en sentido contrario a las agujas del reloj.TrueFalse
