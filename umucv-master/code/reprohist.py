...
for key, frame in autoStream():
    ...
    if H is not None:
        b, g, r = np.floor_divide(frame, 16).transpose(2, 0, 1)#Se transforman en indices para  indexar
        L = H[b, g, r]  # indexa el array H simultáneamente en todos los
        # pixels de la imagen.
        # L donde cada elemento representa la probabilidad de que el pixel correspondiente en la imagen sea similar a la ROI.
